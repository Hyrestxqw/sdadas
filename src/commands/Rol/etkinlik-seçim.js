...
module.exports = {
    ...
    execute: async (client, message, args, embed, author, channel, guild) => {
      ...
      let button1 = new Discord.MessageButton()
          .setStyle('SUCCESS')
          .setEmoji('')
          .setLabel('Hazır Sistemler')
          .setCustomId('etkinlik')
  
      let button2 = new Discord.MessageButton()
          .setStyle('SUCCESS')
          .setEmoji('')
          .setLabel('Hazır Kodlar')
          .setCustomId('cekilis')
...
<@&${config.buttons.çekiliş}>:  Hazır Sistem/Hazır Altyapılara Ulaşmak İçin Hazır Sistemler Butonuna Basınız
  
<@&${config.buttons.etkinlik}>: Hazır Kodlara Ulaşmak İçin Hazır Kodlar Butonuna Basınız
